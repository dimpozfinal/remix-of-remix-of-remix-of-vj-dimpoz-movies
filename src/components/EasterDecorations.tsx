const symbols = [
  ...
  { emoji: "🕊️", bottom: "25%", left: "2%", size: "text-2xl", anim: "holy-float", delay: "0.5s" },
  { emoji: "🕯️", top: "50%", right: "3%", size: "text-lg", anim: "candle-flicker", delay: "2s" },
  { emoji: "🙏", top: "70%", left: "4%", size: "text-xl", anim: "holy-float", delay: "1.5s" },
  { emoji: "✝️", bottom: "15%", right: "5%", size: "text-xl", anim: "holy-float", delay: "0.8s" },
];
